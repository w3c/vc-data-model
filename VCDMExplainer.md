...
It is worth pointing out why the data model has separate roles of holder and subject. It is recognised that in most cases the holder
of a verifiable credential will be the subject, but in certain cases it will not be. For example, a parent (the holder)
may hold the verifiable credentials of a child (the subject), or a pet lover (the holder) may hold the verifiable credentials 
of its pet (the subject). The advanced concepts section of the data model document deals with these special cases.
